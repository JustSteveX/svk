<x-app-layout>
  <div class="pt-20">
  <div class="flex flex-row w-4/6 min-h-screen gap-8 px-8 pt-4 mx-auto bg-accent-50">
    <section class="flex flex-col h-fit w-1/2 gap-4 justify-evenly mt-10 pl-8 border-l-2 border-[#66a782]">
