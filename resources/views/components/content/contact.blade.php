<x-app-layout>
  <div class="flex flex-row w-4/6 gap-8 mx-auto mt-48">
    <section class="flex flex-col w-1/2 gap-1 py-2 pl-4 border-l-2 border-green-600">
      ...
      <p>Telefon: <a class="hover:text-gray-500 hover:underline" href="tel:492443/7489">02443/7489</a></p>
      <p>Vereinslokal: Schützenhaus Kommern</p>
      <p>Gründungsjahr: 1859</p>
      <p>Präsident: Thomas Bank</p>
      <p>E-Mail: <a class="hover:text-gray-500 hover:underline"
    ...
    <section class="w-1/2">
      ...
      <small><a href="https://www.openstreetmap.org/?mlat=50.60707&amp;mlon=6.64640#map=19/50.60707/6.64640">In
