<x-app-layout>
  <div class="max-w-6xl pt-4 mx-auto my-4">
    @forelse ($eventList as $eventItem)
      <div class="flex flex-row h-32 my-4 bg-gray-900 bg-opacity-80">
        ...
        <div class="bg-gray-900 h-full grow-0 min-w-[8rem] flex flex-col justify-center gap-2">
          @if ($eventItem->fb_link)
            <a href="{{ $eventItem->fb_link }}" class="mx-auto rounded" data-tooltip-style="light"
          ...
          @if ($eventItem->gmap_link)
            <a href="{{ $eventItem->gmap_link }}" class="mx-auto rounded" data-tooltip-style="light"
              data-tooltip-target="tooltip-gmaps">
