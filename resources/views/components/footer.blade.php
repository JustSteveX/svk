<footer class="flex flex-col justify-between w-full bg-accent-900 h-72 text-accent-50">
		...
		<div class="max-w-sm pb-2 mx-auto text-xs font-extrabold text-left text-white">
        ...
        <ul class="flex list-['|'] justify-between">
          <li class="list-none"><p>v{{ app()->version() }}</p></li>
          <li class="pl-3"><a class="text-accent-200 hover:text-accent-50 hover:underline" href="{{ route('impressum') }}">Impressum</a></li>
          <li class="pl-3"><a class="text-accent-200 hover:text-accent-50 hover:underline" href="{{ route('datenschutz') }}">Datenschutz</a></li>
          <li class="pl-3">
            @if (!Auth::check())
