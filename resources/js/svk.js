...
function scrollCarousel(direction) {
	...
	const scrollStep =
		(direction === 'back' ? -1 : 1) *
		carouselElem.getElementsByClassName('carousel-container')[0]
			.offsetWidth;
	console.log(
		`ClientWidth: ${carouselElem.clientWidth} && ScrollWidth: ${carouselElem.scrollWidth}`
	);
	...
	if (
		direction === 'forward' &&
		carouselElem.scrollLeft === carouselElem.scrollLeftMax
	) {
